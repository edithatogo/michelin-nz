...
* **In-Browser Database:** [DuckDB WASM](https://duckdb.org/docs/api/wasm/overview) - Fast client-side analytical database running queries directly against compressed Parquet assets.
