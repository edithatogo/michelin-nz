...
- [x] **Track: Project Scaffolding & Observable Bootstrapping**
  - **ID:** `bootstrap`
  - **Status:** `archived`
  - **Implementation Plan:** [bootstrap/index.md](file:///Volumes/PortableSSD/GitHub/michelin-nz/conductor/archive/bootstrap/index.md)
- [x] **Track: Data loader Pipeline & Scraping**
  - **ID:** `data_loader`
  - **Status:** `archived`
  - **Implementation Plan:** [data_loader/index.md](file:///Volumes/PortableSSD/GitHub/michelin-nz/conductor/archive/data_loader/index.md)
- [x] **Track: Core Visualizations & DuckDB Integration**
  - **ID:** `core_viz`
  - **Status:** `archived`
  - **Implementation Plan:** [core_viz/index.md](file:///Volumes/PortableSSD/GitHub/michelin-nz/conductor/archive/core_viz/index.md)
- [x] **Track: WebGL Mapping & Spatial Binning**
  - **ID:** `mapping`
  - **Status:** `archived`
  - **Implementation Plan:** [mapping/index.md](file:///Volumes/PortableSSD/GitHub/michelin-nz/conductor/archive/mapping/index.md)
- [x] **Track: Deep Linking, Community Review CMS & Automation**
  - **ID:** `linking_cms`
  - **Status:** `archived`
  - **Implementation Plan:** [linking_cms/index.md](file:///Volumes/PortableSSD/GitHub/michelin-nz/conductor/archive/linking_cms/index.md)
