...
6. Run the `External Deployment Check` workflow manually.
7. If Zenodo minted a DOI, add it to `CITATION.cff` and replace the README Zenodo note with a DOI badge/link.
